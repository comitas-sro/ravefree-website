export function SignUpForm() {
  return (
    <div className="site-container flex justify-center mt-16">
      <div
        className="group max-w-xl relative h-full w-full rounded-2xl bg-gradient-to-br from-primary-500 via-base-300/50 to-base-300/50
